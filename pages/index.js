      ...
      <main className="bg-white px-10 dark:bg-gray-900 md:px-20 lg:px-40">
        <section className="min-h-screen">
          <nav className="py-10 mb-12 flex justify-between dark:text-white">
            ...
            <ul className="flex items-center">
              ...
              <li>
                <a
                  className="bg-gradient-to-r from-cyan-500 to-teal-500 text-white px-4 py-2 border-none rounded-md ml-8 font-burtons text-xl"
          ...
          <div className="text-center p-10 py-10">
            ...
            <div className="text-5xl flex justify-center gap-16 py-3 text-gray-600 dark:text-gray-400">
              ...
              <a href="https://www.linkedin.com/in/abdullah-rh-aaa217287">
                <AiFillLinkedin />
              </a>
        ...
        <section className="py-10">
          <div className="relative bg-gradient-to-r from-purple-500 to-pink-500 p-12 rounded-lg shadow-2xl hover:scale-105 transition-transform duration-500">
            ...
            <p className="text-lg text-gray-100 mb-8 relative z-10">
            ...
            <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-r from-purple-500 to-pink-500 opacity-0 hover:opacity-100 transition-opacity duration-500"></div>
            <div className="absolute top-0 left-0 w-full h-full flex items-center justify-center pointer-events-none opacity-0 hover:opacity-100 transition-opacity duration-500">
              <h3 className="text-7xl font-extrabold text-white tracking-tight leading-tight animate-bounce">
                Super Portfolio
              </h3>
            </div>
          </div>
